...
<div class="product-cart-wrap">
							...
							<td class="item-description">
								...
								<div class="product-details">
									...
									<?php
										...
										echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s"><span class="icon"></span>Remove</a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Remove this item', 'woocommerce' ) ), $cart_item_key );
										echo '</div>';
									?>
				...
				<td colspan="6" class="actions">
					...
					<?php if ( WC()->cart->coupons_enabled() ) { ?>
						<div class="coupon">
							...
							<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon Code', 'woocommerce' ); ?>" /> <input type="submit" class="button coupon-submit" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
	...
	<div class="cart-totals span3">
		...
		<input type="submit" class="button update" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" />
		<input type="submit" class="checkout-button wc-forward button alt" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
